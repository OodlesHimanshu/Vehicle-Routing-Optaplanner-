...
public class Customer {
    ...
    private Customer previousVisit;
    ...
    public Customer(int id, String name, Location location, int demand,
    ...
    public Customer getPreviousVisit() {
        return previousVisit;
    }

    public void setPreviousVisit(Customer previousVisit) {
